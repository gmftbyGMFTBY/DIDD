...
if __name__ == "__main__":
    ...
    raw_quality_dis = {'low-high': 0.1, 'low-medium': 0.2, 'medium-high': 0.7}
    ...
    if args.reverse == 1:
        ...
        domains_dis = [0 if domains_dis[key] == 0 else 1/domains_dis[key] for key in keys]
        ...
        qualities_dis = [0 if qualities_dis[key] == 0 else 1/qualities_dis[key] for key in keys]
