...
root_path=iter_exp_20250227_v2
iter_num=2
test_query_num=100
gen_num=5
few_shot_num=3
...
### iter exp model pathes
#model_path=/home/lt/NewPoNe/model/internlm2-7b-chat
#model_path=/home/lt/ReNewPoNe/framework/save/comp_iter_0_v2_only/iter_1620_merge_hf
model_path=/home/lt/ReNewPoNe/framework/save/comp_iter_01_v2_only/iter_3324_merge_hf
...
mode=mixture
mixture_rate=0.4 # the mixture weight of new distribution

# 1. generate test set
# generate file: {root_path}/iter_{iter_num}/test_set_gn_{gen_num}_fsn_{few_shot_num}
./run_test_set_construction_v2.sh $root_path $iter_num $gen_num $few_shot_num $test_query_num

# 2. evaluate
# generate file: {root_path}/iter_{iter_num}/model_prediction.json
./run_evaluate_v2.sh $root_path $iter_num $gen_num $few_shot_num $model_path $model_bsz $cuda_gpu_index $test_query_num

# 3. prediciton
#generate file: {root_path}/iter_{iter_num}/meta_evaluation.json
./run_meta_evaluate_v2.sh $root_path $iter_num $gen_num $few_shot_num $model_path
...
./run_train_set_construction_v2.sh $root_path $iter_num $train_num_each $few_shot_num $failure_dis_file $train_query_num $mode $mixture_rate
