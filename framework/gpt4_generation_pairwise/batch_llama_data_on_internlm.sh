...
root_path=data_baseline_20250227_llama3_data_on_internlm
iter_num=0
test_query_num=100
gen_num=1
few_shot_num=3
...
#model_path=/home/lt/ReNewPoNe/pairwise/save/llama3_8b_overall/iter_2576_merge_hf
...
mode=mixture
mixture_rate=0.9 # the mixture weight of new distribution
