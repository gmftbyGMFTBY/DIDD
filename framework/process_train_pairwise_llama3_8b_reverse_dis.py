...
if __name__ == "__main__":
    ...
    iter_data = [
        'gpt4_generation_pairwise/data_baseline_20250226_llama3_base_model_reverse_dis/iter_0/train_set_gn_100_10_fsn_3_mode_mixture_rate_0.5'
    ]
    baseline_data = []
    ...
    with open(f'data/llama_3_comp_reverse_20250402.json', 'w') as f:
