...
if __name__ == "__main__":
    ...
    iter_data = [
        ...
        #'/home/lt/ReNewPoNe/framework/gpt4_generation_pairwise/data_revision_20250715_qwen2_5_0_5B/iter_0/train_set_gn_100_10_fsn_3_mode_mixture_rate_0.5'
        ...
        #'/home/lt/ReNewPoNe/framework/gpt4_generation_pairwise/data_revision_20250715_qwen2_5_3B/iter_0/train_set_gn_100_10_fsn_3_mode_mixture_rate_0.5'
        '/home/lt/ReNewPoNe/framework/gpt4_generation_pairwise/data_revision_20250715_qwen2_5_7B/iter_0/train_set_gn_100_10_fsn_3_mode_mixture_rate_0.5'
    ]
    baseline_data = []
    ...
    for num in [2000]:
        ...
        with open(f'data/comp_iter_train_num_{num}_qwen2.5-7B.json', 'w') as f:
