...
if __name__ == "__main__":
    ...
    iter_data = [
        'gpt4_generation_pairwise/data_baseline_overall_dis_20250218_reverse_dis_internlm2/iter_0/train_set_gn_100_10_fsn_3_mode_mixture_rate_0.0'
    ]
    baseline_data = []
    ...
    with open(f'data/internlm2_7b_comp_reverse_20250402.json', 'w') as f:
