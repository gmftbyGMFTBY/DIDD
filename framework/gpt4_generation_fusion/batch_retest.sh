...
# 6. hard_2: 0.7, hard_1: 0.2, easy: 0.1

#### paramters
#root_path=data_ultracm_20250218
root_path=data_20250224_new_resquality_dis_from_hard_2
iter_num=0
test_query_num=100
gen_num=5
few_shot_num=3
...
model_path=/home/lt/ReNewPoNe/pairwise/save/hard_2/iter_2028_merge_hf
model_bsz=32
cuda_gpu_index=2
